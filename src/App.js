    ...
    en: {
        ...
        questionSets: {
            ...
            interaction: [
              ...
              { id: "q8", questionText: "Is there enough space in the living room so that people can keep a distance of approximately 1.5 meters from each other during activities or rest periods?", answerOptions: [{ answerText: "Yes" }, { answerText: "Mostly" }, { answerText: "No" }, { answerText: "I don't know" }] },
              { id: "q9", questionText: "Is it possible to open windows or an outside door in the living room for fresh air?", answerOptions: [{ answerText: "Yes" }, { answerText: "No" }, { answerText: "I don't know" }] },
              ...
              { id: "q11", questionText: "What type of ventilation system is installed?", answerOptions: [{ answerText: "Type A: Natural air supply + natural air exhaust (e.g., through window grilles)" }, { answerText: "Type B: Mechanical air supply + natural air exhaust (e.g., through window grilles)" }, { answerText: "Type C: Natural air supply (e.g., through window grilles) + mechanical air exhaust" }, { answerText: "Type D: Mechanical air supply + mechanical air exhaust" }, { answerText: "I don't know" }] },
              ...
              { id: "q14", questionText: "What is the maximal CO₂ level during busy periods?", answerOptions: [{ answerText: "<800 ppm" }, { answerText: "800–1200 ppm" }, { answerText: ">1200 ppm" }, { answerText: "No meter" }, { answerText: "I don't know" }] },
            ...
            organizational: [
                ...
                { id: "q21", questionText: "Is there budget available for adjustments or measures (maintenance, sensors, schedules, PPE, additional staff)?", answerOptions: [{ answerText: "Yes, immediately available" }, { answerText: "Yes, available within 12 months" }, { answerText: "No" }, { answerText: "I don't know" }] }
            ]
        }
    },
    nl: {
        ...
        questionSets: {
            personal: [
              ...
              { id: "q2", questionText: "Welke groep bewoners gebruikt deze woonkamer?", answerOptions: [{ answerText: "Mensen met psychogeriatrische klachten" }, { answerText: "Mensen met somatische klachten" }, { answerText: "Mensen met verstandelijke beperkingen" }, { answerText: "Gemengd" }, { answerText: "Weet ik niet" }] },
              ...
              { id: "q4", questionText: "Kunnen de bewoners tijdelijk apart verblijven bij klachten (bijvoorbeeld op hun eigen kamer)?", answerOptions: [{ answerText: "Ja" }, { answerText: "Sommige wel, sommige niet" }, { answerText: "Nee" }, { answerText: "Weet ik niet" }] },
              { id: "q5", questionText: "Mengen verschillende groepen hier regelmatig?", answerOptions: [{ answerText: "Vaak" },{ answerText: "Regelmatig " }, { answerText: "Soms" }, { answerText: "Zelden of nooit" }, { answerText: "Weet ik niet" }] },
            ],
            interaction: [
              ...
              { id: "q8", questionText: "Is er voldoende ruimte in de woonkamer zodat mensen ongeveer 1,5 meter afstand van elkaar kunnen houden bij activiteiten of rustmomenten?", answerOptions: [{ answerText: "Ja" }, { answerText: "Grotendeels" }, { answerText: "Nee" }, { answerText: "Weet ik niet" }] },
              { id: "q9", questionText: "Is het in de woonkamer mogelijk om ramen of een buitendeur te openen voor frisse lucht?", answerOptions: [{ answerText: "Ja" }, { answerText: "Nee" }, { answerText: "Weet ik niet" }] },
              ...
              { id: "q11", questionText: "Welk type ventilatiesysteem is geinstalleerd?", answerOptions: [{ answerText: "Type A: Natuurlijke luchttoevoer + natuurlijke luchtafvoer (bijvoorbeeld via roosters in het raam)" }, { answerText: "Type B: Mechanische luchttoevoer + natuurlijke luchtafvoer (bijvoorbeeld via roosters in het raam)" }, { answerText: "Type C: Natuurlijke luchttoevoer (bijvoorbeeld via roosters in het raam) + mechanische luchtafvoer" }, { answerText: "Type D: Mechanische luchttoevoer + mechanische luchtafvoer" }, { answerText: "Weet ik niet" }] },
              ...
              { id: "q14", questionText: "Wat is de maximale CO₂‑waarde tijdens drukte?", answerOptions: [{ answerText: "<800 ppm" }, { answerText: "800–1200 ppm" }, { answerText: ">1200 ppm" }, { answerText: "Geen meter" },{ answerText: "Weet ik niet" }] },
            ...
            organizational: [
                ...
                { id: "q21", questionText: "Is er budget beschikbaar voor aanpassingen of maatregelen (onderhoud, sensoren, roosters, PBM, extra personeel)? ", answerOptions: [{ answerText: "Ja, direct beschikbaar" }, { answerText: "Ja, binnen 12 maanden beschikbaar" }, { answerText: "Nee" }, { answerText: "Weet ik niet" }] }
            ]
        }
    }
};
