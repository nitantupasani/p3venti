...
export const recommendations = {
    en: {
      ...
      q14: [
        ["", "Use the CO? value to adjust or activate ventilation.", ""],
        ["Ensure the CO? level remains below 1200 ppm during busy periods. For vulnerable groups, it should be below 800 ppm. If this is not possible, provide more fresh air by, for example, turning up the ventilation system, opening windows, or allowing fewer people into the room.", "Use the CO? value to adjust or activate ventilation.", "A high CO? level indicates that there is little fresh air in the room. This causes a buildup of viral particles and increases the risk of spreading the virus. In long-term care, the guideline is that CO? levels should be below 1200 ppm, but for vulnerable groups, it's better to keep them below 800 ppm. Fresh air also has health benefits: people feel fitter."],
        ["Ensure the CO? level remains below 1200 ppm during busy periods. For vulnerable groups, it should be below 800 ppm. If this is not possible, provide more fresh air by, for example, turning up the ventilation system, opening windows, or allowing fewer people into the room.", "Use the CO? value to adjust or activate ventilation.", "A high CO? level indicates that there is little fresh air in the room. This causes a buildup of viral particles and increases the risk of spreading the virus. In long-term care, the guideline is that CO? levels should be below 1200 ppm, but for vulnerable groups, it's better to keep them below 800 ppm. Fresh air also has health benefits: people feel fitter."],
        ["Ensure the CO? level remains below 1200 ppm during busy periods. For vulnerable groups, it should be below 800 ppm. If this is not possible, provide more fresh air by, for example, turning up the ventilation system, opening windows, or allowing fewer people into the room.", "Use the CO? value to adjust or activate ventilation.", "A high CO? level indicates that there is little fresh air in the room. This causes a buildup of viral particles and increases the risk of spreading the virus. In long-term care, the guideline is that CO? levels should be below 1200 ppm, but for vulnerable groups, it's better to keep them below 800 ppm. Fresh air also has health benefits: people feel fitter."],
      ],
      q15: [
    ...
    nl: {
      ...
      q14: [
        ["", "Gebruik de CO?-waarde om de ventilatie aan te passen of te activeren.", ""],
        ["Zorg ervoor dat het CO?-niveau tijdens drukke periodes onder de 1200 ppm blijft. Voor kwetsbare groepen moet het onder de 800 ppm zijn. Als dit niet mogelijk is, zorg dan voor meer frisse lucht door bijvoorbeeld het ventilatiesysteem hoger te zetten, ramen te openen of minder mensen in de kamer toe te laten.", "Gebruik de CO?-waarde om de ventilatie aan te passen of te activeren.", "Een hoog CO?-niveau geeft aan dat er weinig frisse lucht in de kamer is. Dit veroorzaakt een ophoping van virusdeeltjes en verhoogt het risico op verspreiding van het virus. In de langdurige zorg is de richtlijn dat het CO?-niveau onder de 1200 ppm moet liggen, maar voor kwetsbare groepen is het beter om het onder de 800 ppm te houden. Frisse lucht heeft ook gezondheidsvoordelen: mensen voelen zich fitter."],
        ["Zorg ervoor dat het CO?-niveau tijdens drukke periodes onder de 1200 ppm blijft. Voor kwetsbare groepen moet het onder de 800 ppm zijn. Als dit niet mogelijk is, zorg dan voor meer frisse lucht door bijvoorbeeld het ventilatiesysteem hoger te zetten, ramen te openen of minder mensen in de kamer toe te laten.", "Gebruik de CO?-waarde om de ventilatie aan te passen of te activeren.", "Een hoog CO?-niveau geeft aan dat er weinig frisse lucht in de kamer is. Dit veroorzaakt een ophoping van virusdeeltjes en verhoogt het risico op verspreiding van het virus. In de langdurige zorg is de richtlijn dat het CO?-niveau onder de 1200 ppm moet liggen, maar voor kwetsbare groepen is het beter om het onder de 800 ppm te houden. Frisse lucht heeft ook gezondheidsvoordelen: mensen voelen zich fitter."],
        ["Zorg ervoor dat het CO?-niveau tijdens drukke periodes onder de 1200 ppm blijft. Voor kwetsbare groepen moet het onder de 800 ppm zijn. Als dit niet mogelijk is, zorg dan voor meer frisse lucht door bijvoorbeeld het ventilatiesysteem hoger te zetten, ramen te openen of minder mensen in de kamer toe te laten.", "Gebruik de CO?-waarde om de ventilatie aan te passen of te activeren.", "Een hoog CO?-niveau geeft aan dat er weinig frisse lucht in de kamer is. Dit veroorzaakt een ophoping van virusdeeltjes en verhoogt het risico op verspreiding van het virus. In de langdurige zorg is de richtlijn dat het CO?-niveau onder de 1200 ppm moet liggen, maar voor kwetsbare groepen is het beter om het onder de 800 ppm te houden. Frisse lucht heeft ook gezondheidsvoordelen: mensen voelen zich fitter."],
      ],
      q15: [
