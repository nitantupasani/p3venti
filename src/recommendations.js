...
export const recommendations = {
    en: {
        q1: [
          ["The number of people in the living room is not too high. No action required.", "Organize care so that groups are neither too small nor too large. The ideal size is 8 people.", "The ideal group size is 8 people, according to the National Organization of Client Councils. \"The main reason is that group size largely determines the level of anxiety among residents. Within larger groups, there is less time to tailor care to the wishes and needs of each person, so that they can live their life in a way that suits them.\" https://www.clientenraad.nl/publicaties/bewaarkaart-groepsformaat-kleinschalig-wonen/"],
          ["Ensure that people can maintain sufficient distance in the living room, or ensure there are fewer people in the living room.", "Organize care so that groups are neither too small nor too large. The ideal size is 8 people.", "The ideal group size is 8 people, according to the National Organization of Client Councils. \"The main reason is that group size largely determines the level of anxiety among residents. Within larger groups, there is less time to tailor care to the wishes and needs of each person, so that they can live their life in a way that suits them.\" https://www.clientenraad.nl/publicaties/bewaarkaart-groepsformaat-kleinschalig-wonen/"],
        ...
        q3: [
          ["People are not in the living room for too long. No action required.", "Make sure that people have social contacts during the day.", "The longer people are present in a room, the more virus particles will build up and linger in the space. However, the more time people spend in a room, the more interactions they can have, which is good for well-being."],
        ...
        q8: [
          ["Ensure people are seated 1.5 meters apart.", "No action required. If the layout changes, ensure that people can still sit 1.5 meters apart.", "Social distancing is good for safety. It reduces the risk of people infecting each other. It does, however, limit social interactions."],
        ...
        q9: [
          ...
          ["If there are no windows or doors, turn up the ventilation system.", "Make sure there are enough windows that open easily.", "Opening windows allows more fresh air to enter. This is important during a pandemic. Being able to open and close windows yourself provides autonomy, control, and a sense of security for staff and residents. Be aware that this can lead to drafts, cold, and respiratory problems."],
          ["Check if any windows and doors can be opened to the outside.", "Make sure there are enough windows that open easily.", "Opening windows also allow more fresh air to enter. This is crucial during a pandemic. Being able to open and close windows yourself provides autonomy, control, and a sense of security for staff and residents. However, be aware that this can lead to drafts, cold, and respiratory problems."],
          ["", "", ""],
        ],
        q10: [
          ...
          ["If there are no ventilation grilles, turn up the ventilation system.", "Make sure there are sufficient ventilation grilles and that they are well-maintained so they are always clean.", "Ventilation grilles provide more fresh air. This is important during a pandemic. Being able to open and close the grilles yourself provides autonomy, control, and a sense of security for staff and residents. However, be aware that this can lead to drafts, cold, and respiratory problems."],
          ["Determine if there are any ventilation grilles.", "Make sure there are sufficient ventilation grilles and that they are well-maintained so they are always clean.", "Ventilation grilles provide more fresh air. This is important during a pandemic. Being able to open and close the grilles yourself provides autonomy, control, and a sense of security for staff and residents. However, be aware that this can lead to drafts, cold, and respiratory problems."],
        ],
        q11: [
        ...
        q12: [
          ...
          ["No air recirculation. No action required.", "Ensure that there's no recirculation in the future either.", "Air recirculation means that contaminated air is returned to the room. This accelerates the spread of a virus."],
          ["Ask technical support to turn off recirculation.", "Invest in a ventilation system that does not recirculate air.", "Air recirculation means that contaminated air is returned to the room. This accelerates the spread of a virus."],
        ],
        q13: [
          ["Use the air quality meter to monitor proper ventilation.", "Ensure there are air quality meters in every room and that the ventilation system is controlled by them.", "Air quality meters provide insight into the amount of fresh air in a room. If there is little fresh air, a virus will accumulate more and spread more quickly."],
          ["Purchase an air quality meter for the room.", "Ensure there are air quality meters in every room and that the ventilation system is controlled by them.", "Air quality meters provide insight into the amount of fresh air in a room. If there is little fresh air, a virus will accumulate more and spread more quickly."],
          ["Check if the room has an air quality meter.", "Ensure there are air quality meters in every room and that the ventilation system is controlled by them.", "Air quality meters provide insight into the amount of fresh air in a room. If there is little fresh air, a virus will accumulate more and spread more quickly."],
        ],
        q14: [
            ["The CO₂ level is fine. No action is required.", "Use the CO2 value to adjust or activate ventilation.", "A high CO₂ level indicates that there is little fresh air in the room. This causes a buildup of viral particles and increases the risk of spreading the virus. In long-term care, the guideline is that CO₂ levels should be below 1200 ppm, but for vulnerable groups, it's better to keep them below 800 ppm. Fresh air also has health benefits: people feel fitter."],
        ...
        q15: [
          ["The ventilation system has been serviced. No action is required.", "Ensure regular inspections and maintenance.", "A well-maintained ventilation system ensures safe indoor air quality. Virus particles are then less likely to linger in the air and infect people. Knowing that the system is being properly maintained provides a sense of security for staff and residents and increases their confidence in the ventilation system."],
        ...
        q17: [
          ["Clear instructions are provided. No action is required.", "Establish guidelines and instructions. Ensure all staff and residents understand and know where to find these instructions.", "With clear instructions, everyone can help with proper ventilation. This not only improves indoor air quality but also fosters autonomy."],
        ...
        q18: [
          ["PPE available. No action required.", "Ensure there is always sufficient personal protective equipment (PPE) where needed.", "Personal protective equipment (PPE) ensures that staff can do their work safely and that residents are protected from the virus."],
        ...
        q19: [
          ["No unoccupied shifts. No action required.", "Ensure there are also no unoccupied shifts in the future.", "Ensuring that all shifts are staffed by the right people is crucial for continuity of care. If this isn't the case, additional measures will be difficult to implement. This will compromise the physical and mental care of the resident and the quality of work for the staff."],
        ...
        q20: [
          ["Working in fixed teams. No action required.", "Fixed teams mean that staff move between living rooms and departments as little as possible. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, keep a closer eye on residents, and recognize if something is wrong with someone. Without permanent teams, there is more interaction, freedom, and autonomy.", "Fixed teams mean that staff move between living rooms and departments as little as possible. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, keep a closer eye on residents, and recognize if something is wrong with someone. Without permanent teams, there is more interaction, freedom, and autonomy."],
          ["Work in permanent teams and groups.", "Fixed teams mean that staff move between living rooms and departments as little as possible. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, keep a closer eye on residents, and recognize if something is wrong with someone. Without permanent teams, there is more interaction, freedom, and autonomy.", "Fixed teams/groups mean that staff move between rooms and departments as little as possible and that residents live in fixed groups. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, monitor residents more closely, and recognize if something is wrong with someone. However, not working with fixed teams and groups allows more interactions, freedom and autonomy."],
          ["Work in permanent teams and groups.", "Fixed teams mean that staff move between living rooms and departments as little as possible. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, keep a closer eye on residents, and recognize if something is wrong with someone. Without permanent teams, there is more interaction, freedom, and autonomy.", "Fixed teams/groups mean that staff move between rooms and departments as little as possible and that residents live in fixed groups. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, monitor residents more closely, and recognize if something is wrong with someone. However, not working with fixed teams and groups allows more interactions, freedom and autonomy."],
          ["Find out if you are working in fixed teams.", "Fixed teams mean that staff move between living rooms and departments as little as possible. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, keep a closer eye on residents, and recognize if something is wrong with someone. Without permanent teams, there is more interaction, freedom, and autonomy.", "Fixed teams/groups mean that staff move between rooms and departments as little as possible and that residents live in fixed groups. This reduces the risk of one group infecting another. This is also beneficial because it provides clarity for staff and residents. Residents are less likely to become overstimulated, and staff can maintain a better overview, monitor residents more closely, and recognize if something is wrong with someone. However, not working with fixed teams and groups allows more interactions, freedom and autonomy."],
        ],
        q21: [
          ["There is budget available to invest in adjustments or measures (maintenance, sensors, schedules, PPE, additional staff). No action required.", "Ensure that any adjustments that are already possible are already implemented (maintenance, sensors, schedules) and that there is a structural budget for additional adjustments or measures (PPE, additional staff).", "Adjustments and measures to ensure the safety of staff and residents often cost money. It is important that this is factored into the budget. Also consider unexpected costs. This ensures a safe working and living environment."],
          ["Ensure that any adjustments that are already possible are already implemented (maintenance, sensors, schedules) and that there is a structural budget for additional adjustments or measures (PPE, additional staff).", "Ensure that any adjustments that are already possible are already implemented (maintenance, sensors, schedules) and that there is a structural budget for additional adjustments or measures (PPE, additional staff).", "Adjustments and measures to ensure the safety of staff and residents often cost money. It is important that this is factored into the budget. Also consider unexpected costs. This ensures a safe working and living environment."],
          ["Allocate additional budget to invest in adjustments or measures (maintenance, sensors, schedules, PPE, additional staff).", "Ensure that any adjustments that are already possible are already implemented (maintenance, sensors, schedules) and that there is a structural budget for additional adjustments or measures (PPE, additional staff).", "Adjustments and measures to ensure the safety of staff and residents often cost money. It is important that this is factored into the budget. Also consider unexpected costs. This ensures a safe working and living environment."],
          ["Determine if there is budget available to invest in adjustments or measures (maintenance, sensors, schedules, PPE, additional staff).", "Ensure that any adjustments that are already possible are already implemented (maintenance, sensors, schedules) and that there is a structural budget for additional adjustments or measures (PPE, additional staff).", "Adjustments and measures to ensure the safety of staff and residents often cost money. It is important that this is factored into the budget. Also consider unexpected costs. This ensures a safe working and living environment."],
        ],
    },
    nl: {
        q1: [
